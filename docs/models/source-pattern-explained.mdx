...
- An organization can be dissolved when absorbed by another organization (`P99i was dissolved by` -> E68 Dissolution). The E74 entities merge, but the E24 might keep its physical boundaries.
