  ...
  return (
    <div className="space-y-1 max-h-80 overflow-y-auto pr-1">
      {sorted.map((obs) => (
        <div
          key={obs['@id']}
          className="border border-gray-200 rounded p-2 text-xs hover:bg-gray-50 transition-colors"
        >
          <div className="flex items-center justify-between mb-1">
            ...
            <div className="flex gap-1">
              {obs.product && (
                <span className="bg-emerald-50 text-emerald-700 px-1.5 py-0.5 rounded text-[10px]">
                  {obs.product}
                </span>
              )}
              {obs.deserted && (
          ...
          <div className="grid grid-cols-[auto_1fr] gap-x-2 gap-y-0.5 text-gray-600">
            ...
            {obs.enslavedCount != null && (
              <>
                <span className="text-gray-400">Enslaved:</span>
